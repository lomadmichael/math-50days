...
const DAY_TO_EBS_LECTURES: Record<string, number[]> = {
  ...
  // ============ grade1 (중1) ============
  // PART 1: 수와 연산 (Day 1~7)
  'grade1-1': [], 'grade1-2': [], 'grade1-3': [],
  'grade1-4': [17], 'grade1-5': [17, 18], 'grade1-6': [18], 'grade1-7': [],
  // PART 2: 문자와 식 (Day 8~14)
  'grade1-8': [1], 'grade1-9': [2], 'grade1-10': [3],
  'grade1-11': [4], 'grade1-12': [5], 'grade1-13': [6], 'grade1-14': [24],
  // PART 3: 좌표평면과 그래프 (Day 15~21)
  'grade1-15': [35], 'grade1-16': [35], 'grade1-17': [36],
  'grade1-18': [37], 'grade1-19': [38], 'grade1-20': [39], 'grade1-21': [40],
  // PART 4: 기본 도형 (Day 22~28)
  'grade1-22': [47], 'grade1-23': [47], 'grade1-24': [48],
  'grade1-25': [48], 'grade1-26': [49], 'grade1-27': [49], 'grade1-28': [50],
  // PART 5: 평면도형 (Day 29~35)
  'grade1-29': [51], 'grade1-30': [51], 'grade1-31': [52],
  'grade1-32': [52], 'grade1-33': [53], 'grade1-34': [54], 'grade1-35': [55],
  // PART 6: 입체도형 (Day 36~42) — 50일 수학 직접 대응 없음
  // PART 7: 통계 기초 (Day 43~50) — 50일 수학 직접 대응 없음
  'grade1-50': [69],
