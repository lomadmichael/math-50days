...
const dayContent: DayContent = {
  ...
  part: 1,
  title: '소수와 소인수분해',
  subtitle: '약수가 1과 자기 자신뿐인 특별한 수, 소수! 그리고 모든 수를 소수로 쪼개는 소인수분해!',
  lectures: [
    {
      lectureNumber: 1,
      youtubeVideoId: '',
  ...
  realLifeExample: '소수는 암호학에서 아주 중요해요! 인터넷 뱅킹, 카카오톡 메시지 암호화 등 모두 큰 소수의 곱셈을 이용합니다. 두 큰 소수를 곱하면 쉽지만, 결과에서 원래 소수를 찾는 건 매우 어렵기 때문이에요!',
};
