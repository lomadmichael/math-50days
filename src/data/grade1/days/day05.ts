...
const dayContent: DayContent = {
  ...
  part: 1,
  title: '정수의 덧셈과 뺄셈',
  subtitle: '양수끼리, 음수끼리, 그리고 부호가 다른 수의 덧셈과 뺄셈을 마스터하자!',
  lectures: [],
  concepts: [
    {
      id: 'g1d5-c1',
      title: '부호가 같은 두 정수의 덧셈',
      content: '**같은 부호끼리 더할 때**: 절댓값을 더하고, **공통 부호**를 붙인다\n\n$(+3) + (+5) = +(3+5) = +8$\n$(-3) + (-5) = -(3+5) = -8$\n\n양수 + 양수 = 양수\n음수 + 음수 = 음수',
      type: 'formula',
    },
    {
      id: 'g1d5-c2',
      title: '부호가 다른 두 정수의 덧셈',
      content: '**다른 부호끼리 더할 때**: 절댓값의 **차**를 구하고, **절댓값이 큰 쪽의 부호**를 붙인다\n\n$(+7) + (-3) = +(7-3) = +4$\n$(+3) + (-7) = -(7-3) = -4$\n\n줄다리기를 생각하면 쉬워요! 센 쪽이 이기고, 차이만큼 당겨집니다.',
      type: 'formula',
    },
    {
      id: 'g1d5-c3',
      title: '정수의 뺄셈',
      content: '뺄셈은 **부호를 바꿔서 더하기**로 바꾼다!\n\n$a - b = a + (-b)$\n\n예시:\n$(+5) - (+3) = (+5) + (-3) = +2$\n$(+5) - (-3) = (+5) + (+3) = +8$\n$(-5) - (+3) = (-5) + (-3) = -8$\n$(-5) - (-3) = (-5) + (+3) = -2$\n\n핵심: 빼기 → 부호 바꿔서 더하기!',
      type: 'formula',
    },
    {
      id: 'g1d5-c4',
      title: '덧셈의 교환법칙과 결합법칙',
      content: '정수의 덧셈에서도 성립합니다!\n\n**교환법칙**: $a + b = b + a$\n**결합법칙**: $(a + b) + c = a + (b + c)$\n\n여러 수를 더할 때 **양수끼리, 음수끼리** 모아서 계산하면 편리해요!\n\n예: $(+3) + (-5) + (+7) + (-2)$\n$= (3 + 7) + (-5 + (-2))$\n$= 10 + (-7) = 3$',
      type: 'tip',
    },
  ],
  problems: [
