...
const dayContent: DayContent = {
  ...
  part: 2,
  title: '유리수의 개념',
  subtitle: '분수로 나타낼 수 있는 수, 유리수! 정수와 어떤 관계일까?',
  lectures: [
    {
      lectureNumber: 1,
      youtubeVideoId: '',
  ...
  realLifeExample: '피자 한 판을 8조각으로 나눠서 3조각 먹으면 $\\frac{3}{8}$만큼 먹은 거예요. 이처럼 일상에서 분수(유리수)를 계속 사용합니다. 할인율 30%도 $\\frac{30}{100} = \\frac{3}{10}$으로 유리수!',
};
