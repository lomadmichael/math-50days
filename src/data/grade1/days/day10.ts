...
const dayContent: DayContent = {
  ...
  part: 2,
  title: '수의 체계 정리',
  subtitle: '자연수(Natural Number)부터 유리수(Rational Number)까지, 수의 세계를 한눈에 정리하자!',
  lectures: [],
  concepts: [
    {
      id: 'g1d10-c1',
      title: '수의 체계 (중1 범위)',
      content: '**자연수(Natural Number)** ⊂ **정수(Integer)** ⊂ **유리수(Rational Number)**\n\n• 자연수(Natural Number): 1, 2, 3, 4, ...\n• 정수(Integer): ..., -2, -1, 0, 1, 2, ...\n• 유리수(Rational Number): $\\frac{a}{b}$ (a, b 정수, $b \\neq 0$)\n\n모든 자연수는 정수이고, 모든 정수는 유리수입니다!\n(중2에서 무리수(Irrational Number), 중3에서 실수를 배우게 됩니다)',
      type: 'definition',
    },
    {
      id: 'g1d10-c2',
    ...
    },
    {
      id: 'g1d10-c3',
      title: '수의 성질 정리',
      content: '**덧셈(Addition)의 항등원**: 0 ($a + 0 = a$)\n**곱셈(Multiplication)의 항등원**: 1 ($a \\times 1 = a$)\n**덧셈의 역원**: $-a$ ($a + (-a) = 0$)\n**곱셈의 역원(역수, Reciprocal)**: $\\frac{1}{a}$ ($a \\times \\frac{1}{a} = 1$, $a \\neq 0$)\n\n0은 역수(Reciprocal)가 없습니다! (0으로 나눌 수 없음)',
      type: 'formula',
    },
    {
      id: 'g1d10-c4',
      title: '자주 틀리는 포인트',
      content: '• 0(Zero)은 양수(Positive Number)가 아니다! (양수도 음수도 아님)\n• 0은 자연수(Natural Number)가 아니다! (1부터 시작)\n• 0은 유리수(Rational Number)다! ($\\frac{0}{1} = 0$)\n• 모든 정수(Integer)는 유리수다! ($5 = \\frac{5}{1}$)\n• $\\frac{a}{0}$은 정의되지 않는다! (0으로 나눌 수 없음)\n• $-(-a) = a$ (마이너스 마이너스는 플러스)',
      type: 'warning',
    },
  ],
  problems: [
  ...
  realLifeExample: '컴퓨터는 모든 수를 0과 1(이진수)로 저장해요. 유한소수는 정확히 저장되지만, 순환소수는 근사값만 저장됩니다. 그래서 프로그래밍에서 0.1 + 0.2가 정확히 0.3이 안 되는 현상이 생겨요! 자연수(Natural Number), 정수(Integer), 유리수(Rational Number)의 수의 체계를 이해하면 이런 현상도 이해할 수 있습니다.',
};
