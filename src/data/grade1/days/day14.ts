...
const dayContent: DayContent = {
  dayNumber: 14,
  part: 3,
  title: '일차식(Linear Expression)의 계산 (덧셈/뺄셈)',
  subtitle: '동류항(Like Terms)을 모아 일차식(Linear Expression)의 덧셈과 뺄셈을 계산하는 방법을 배워보자.',
  lectures: [],
  concepts: [
    {
      id: 'g1d14-c1',
      title: '동류항(Like Terms)이란?',
      content: '**동류항(Like Terms)**: 문자와 차수가 같은 항\n\n예: $3x$와 $-5x$ → 동류항 ✓ (둘 다 $x$)\n$2x$와 $2x^2$ → 동류항 ✗ (차수가 다름)\n$4a$와 $4b$ → 동류항 ✗ (문자가 다름)\n$7$과 $-3$ → 동류항 ✓ (둘 다 상수항(Constant Term))\n\n동류항끼리만 더하고 뺄 수 있습니다!',
      type: 'definition',
    },
    {
      id: 'g1d14-c2',
      title: '동류항(Like Terms)의 덧셈과 뺄셈',
      content: '동류항끼리는 **계수(Coefficient)끼리** 더하거나 빼면 됩니다.\n\n$$3x + 5x = (3 + 5)x = 8x$$\n$$7a - 4a = (7 - 4)a = 3a$$\n$$-2y + 6y = (-2 + 6)y = 4y$$\n\n문자 부분은 그대로 두고, 계수만 계산하면 OK!',
      type: 'formula',
    },
    {
      id: 'g1d14-c3',
      title: '일차식(Linear Expression)의 덧셈과 뺄셈',
  ...
  realLifeExample: '일차식(Linear Expression)의 계산은 생활 속 비용 비교에 유용합니다! A 요금제가 월 기본료 $3000 + 100x$(원), B 요금제가 $5000 + 60x$(원)이라면, 요금 차이는 $(5000 + 60x) - (3000 + 100x) = 2000 - 40x$(원)으로 간단히 비교할 수 있어요.',
};
