...
const dayContent: DayContent = {
  dayNumber: 15,
  part: 3,
  title: '일차식의 계산 (곱셈/나눗셈)',
  subtitle: '일차식에 수를 곱하고 나누는 방법과 분배법칙을 배워보자.',
  lectures: [],
  concepts: [
    {
      id: 'g1d15-c1',
      title: '일차식 × 수',
      content: '일차식에 수를 곱할 때는 **분배법칙**을 사용합니다.\n\n$$a(b + c) = ab + ac$$\n\n예:\n$$3(2x + 5) = 3 \\times 2x + 3 \\times 5 = 6x + 15$$\n$$-2(4x - 3) = -2 \\times 4x + (-2) \\times (-3) = -8x + 6$$\n\n**부호에 주의!** 음수를 곱하면 각 항의 부호가 바뀝니다.',
      type: 'formula',
    },
    {
      id: 'g1d15-c2',
  ...
  realLifeExample: '분배법칙은 암산의 비법이기도 합니다! 예를 들어 $12 \\times 98$을 계산할 때, $12 \\times (100 - 2) = 1200 - 24 = 1176$처럼 쉽게 계산할 수 있어요. 할인 계산에서도 "정가의 30% 할인"은 정가 $\\times 0.7$, 즉 분배법칙의 활용이랍니다!',
};
