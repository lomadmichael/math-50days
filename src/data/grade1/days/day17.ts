...
const dayContent: DayContent = {
  ...
  part: 3,
  title: '일차방정식 풀이',
  subtitle: '방정식이란 무엇이고, 일차방정식은 어떻게 풀까?',
  lectures: [],
  concepts: [
    {
      id: 'g1d17-c1',
      title: '방정식과 항등식',
      content: '• **방정식**: 미지수의 값에 따라 참이 되기도 하고 거짓이 되기도 하는 등식\n  예) $2x + 1 = 7$ → $x = 3$일 때만 참\n• **항등식**: 미지수에 어떤 값을 넣어도 항상 참인 등식\n  예) $2(x + 1) = 2x + 2$ → 항상 참\n• **해(근)**: 방정식을 참이 되게 하는 미지수의 값\n• **풀다**: 방정식의 해를 구하는 것',
      type: 'definition',
    },
    {
      id: 'g1d17-c2',
      title: '일차방정식의 풀이',
      content: '**일차방정식**: 미지수의 차수가 1인 방정식 (예: $ax + b = 0$, $a \\neq 0$)\n\n**풀이 순서**:\n① 괄호가 있으면 분배법칙으로 풀기\n② 미지수가 포함된 항은 **좌변**으로, 상수항은 **우변**으로 이항\n③ 양변을 정리 (동류항 계산)\n④ 미지수의 계수로 양변을 나누기\n\n**이항**: 한쪽 변의 항을 **부호를 바꾸어** 다른 쪽으로 옮기는 것\n$x + 3 = 7$ → $x = 7 - 3$ → $x = 4$',
      type: 'formula',
    },
    {
      id: 'g1d17-c3',
  ...
  realLifeExample: '일차방정식은 일상에서 "모르는 값 구하기"에 활용됩니다. 예를 들어, 과자 3봉지와 음료 1개를 사서 5,000원을 냈는데 거스름돈이 500원이었다면, 과자 한 봉지 가격을 x로 놓고 방정식을 세울 수 있어요!',
};
