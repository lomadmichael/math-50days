...
const dayContent: DayContent = {
  dayNumber: 18,
  part: 3,
  title: '일차방정식(Linear Equation) 활용 (1)',
  subtitle: '문장을 방정식으로! 수에 대한 문제와 나이 문제(Age Problem)를 풀어보자.',
  lectures: [],
  concepts: [
    {
      id: 'g1d18-c1',
      title: '일차방정식(Linear Equation) 활용 풀이 순서',
      content: '**일차방정식(Linear Equation) 활용 문제 풀이 4단계**:\n\n① **미지수(Unknown) 정하기**: 구하려는 것을 $x$로 놓기\n② **방정식 세우기**: 문제의 조건을 등식으로 표현\n③ **방정식 풀기**: 이항(Transposition)과 정리를 통해 $x$ 값 구하기\n④ **확인하기**: 구한 답이 문제 조건에 맞는지 검산',
      type: 'formula',
    },
    {
      id: 'g1d18-c2',
    ...
    {
      id: 'g1d18-c3',
      title: '나이 문제(Age Problem)',
      content: '**나이 문제(Age Problem)의 핵심**: 시간이 흘러도 나이 차이는 변하지 않는다!\n\n**예시**: 현재 아버지는 42세, 아들은 12세이다. 아버지 나이가 아들 나이의 2배가 되는 것은 몇 년 후인가?\n\n$x$년 후라 하면:\n아버지: $42 + x$, 아들: $12 + x$\n\n$42 + x = 2(12 + x)$\n$42 + x = 24 + 2x$\n$42 - 24 = 2x - x$\n$x = 18$\n\n→ **18년 후**',
      type: 'example',
    },
  ],
  problems: [
  ...
  realLifeExample: '일차방정식(Linear Equation) 활용은 "추리"와 비슷합니다! 탐정이 단서를 모아 범인을 찾듯, 문제에서 조건(단서)을 모아 방정식을 세우고 미지수(범인)를 찾는 거예요. 나이 문제, 가격 문제 등 실생활 곳곳에서 활용됩니다.',
};
