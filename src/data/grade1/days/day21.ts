...
const dayContent: DayContent = {
  ...
  part: 4,
  title: '좌표평면 이해하기',
  subtitle: '점의 위치를 숫자 쌍으로 나타내는 좌표평면의 세계로 들어가 보자!',
  lectures: [],
  concepts: [
    {
      id: 'g1d21-c1',
      title: '좌표평면과 좌표축',
      content: '• **좌표평면**: 가로축(**x축**)과 세로축(**y축**)이 직각으로 만나는 평면\n• **원점**: x축과 y축이 만나는 점, $O(0, 0)$\n• x축 위의 점: $y = 0$ → $(a, 0)$\n• y축 위의 점: $x = 0$ → $(0, b)$',
      type: 'concept',
    },
    {
      id: 'g1d21-c2',
      title: '순서쌍과 좌표',
      content: '• **순서쌍**: 두 수를 순서대로 짝지은 것 $(x, y)$\n• $x$좌표: 원점에서 **오른쪽(+)** 또는 **왼쪽(-)** 으로 이동한 거리\n• $y$좌표: 원점에서 **위쪽(+)** 또는 **아래쪽(-)** 으로 이동한 거리\n• 주의: $(2, 3)$과 $(3, 2)$는 서로 **다른 점**이다!',
      type: 'concept',
    },
    {
      id: 'g1d21-c3',
  ...
  realLifeExample: '좌표평면은 지도 앱에서 위치를 나타낼 때 사용됩니다! GPS의 위도와 경도도 순서쌍 형태이고, 게임에서 캐릭터의 위치도 좌표로 표현해요.',
};
