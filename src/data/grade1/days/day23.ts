...
const dayContent: DayContent = {
  dayNumber: 23,
  part: 4,
  title: '정비례(Direct Proportion) 관계',
  subtitle: '한쪽이 커지면 다른 쪽도 같은 비율로 커지는 정비례(Direct Proportion)를 배워 보자!',
  lectures: [],
  concepts: [
    {
      id: 'g1d23-c1',
      title: '정비례(Direct Proportion)란?',
      content: '• **정비례(Direct Proportion)**: $x$가 2배, 3배, ...가 되면 $y$도 2배, 3배, ...가 되는 관계\n• 식: $y = ax$ ($a \\neq 0$인 상수)\n• $a$를 **비례상수(Constant of Proportionality)**라 한다\n• $x$와 $y$의 비 $\\frac{y}{x} = a$로 항상 일정!',
      type: 'definition',
    },
    {
      id: 'g1d23-c2',
      title: '정비례(Direct Proportion) 그래프(Graph)',
      content: '• $y = ax$의 그래프는 **원점을 지나는 직선**\n• $a > 0$: 오른쪽 위로 올라가는 직선 (제1, 3사분면)\n• $a < 0$: 오른쪽 아래로 내려가는 직선 (제2, 4사분면)\n• $|a|$가 클수록 그래프가 y축에 **가까워** (가파름)',
      type: 'formula',
    },
    {
      id: 'g1d23-c3',
      title: '비례상수(Constant of Proportionality) 구하기',
      content: '• $y = ax$에 한 점의 좌표(Coordinates) $(x, y)$를 대입하면 $a$를 구할 수 있다\n• 예: 점 $(2, 6)$을 지나면 $6 = a \\times 2$ → $a = 3$\n• 따라서 $y = 3x$',
      type: 'formula',
    },
  ],
  problems: [
  ...
  realLifeExample: '시속 60km로 달리는 자동차의 이동거리는 시간에 정비례(Direct Proportion)합니다! $y = 60x$ (y: 거리km, x: 시간). 환율도 정비례의 예시인데, 1달러 = 1300원이면 $y = 1300x$로 계산할 수 있어요.',
};
