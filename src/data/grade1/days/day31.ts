...
const dayContent: DayContent = {
  ...
  part: 5,
  title: '삼각형의 합동 조건',
  subtitle: '두 삼각형이 완전히 같은 모양과 크기를 가지려면? 합동의 비밀을 파헤쳐 보자!',
  lectures: [],
  concepts: [
    {
      id: 'g1d31-c1',
      title: '합동의 뜻',
      content: '• **합동**: 모양과 크기가 완전히 같은 두 도형 → 기호: $\\triangle ABC \\equiv \\triangle DEF$\n• 합동인 두 삼각형에서:\n  - **대응변**의 길이가 같다: $\\overline{AB} = \\overline{DE}$, $\\overline{BC} = \\overline{EF}$, $\\overline{CA} = \\overline{FD}$\n  - **대응각**의 크기가 같다: $\\angle A = \\angle D$, $\\angle B = \\angle E$, $\\angle C = \\angle F$\n• 합동 기호를 쓸 때는 대응하는 꼭짓점 순서를 맞춰야 합니다!',
      type: 'definition',
    },
    {
      id: 'g1d31-c2',
      title: '삼각형의 합동 조건',
      content: '두 삼각형이 합동이 되려면 다음 중 하나를 만족하면 됩니다:\n\n• **SSS 합동**: 세 쌍의 대응변의 길이가 각각 같을 때\n• **SAS 합동**: 두 쌍의 대응변의 길이가 같고, 그 **끼인각**의 크기가 같을 때\n• **ASA 합동**: 한 쌍의 대응변의 길이가 같고, 그 **양 끝 각**의 크기가 각각 같을 때',
      type: 'formula',
    },
    {
      id: 'g1d31-c3',
      title: '합동이 아닌 경우 주의!',
      content: '⚠️ 합동 조건이 되지 **않는** 것들:\n• **AAA**: 세 각이 같아도 크기가 다를 수 있음 (닮음)\n• **SSA**: 두 변과 끼인각이 아닌 한 각 → 삼각형이 2개 만들어질 수 있음\n\n합동 조건을 적용할 때는 반드시:\n1. 대응하는 변과 각을 정확히 파악\n2. SAS에서 "끼인각"인지 확인\n3. ASA에서 "양 끝 각"인지 확인',
      type: 'tip',
    },
  ],
  problems: [
  ...
  realLifeExample: '공장에서 같은 규격의 부품을 만들 때 합동의 개념이 사용됩니다. 자동차 좌우 대칭 부품, 타일 붙이기, 퍼즐 조각 맞추기 등에서 합동인 도형을 찾아 활용하는 것이 중요합니다!',
};
