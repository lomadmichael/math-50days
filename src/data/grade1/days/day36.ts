...
const dayContent: DayContent = {
  ...
  subtitle: '부채꼴의 호의 길이와 넓이를 공식으로 구해 보자!',
  lectures: [],
  concepts: [
    {
      id: 'g1d36-c1',
      title: '원의 둘레와 넓이',
      content: '• 원주율 $\\pi$: 원의 지름에 대한 둘레의 비 (약 3.14159...)\n• **원의 둘레**: $2\\pi r$ (또는 $\\pi d$)\n• **원의 넓이**: $\\pi r^2$\n• 예) 반지름 $5\\text{cm}$인 원의 둘레: $2\\pi \\times 5 = 10\\pi\\text{(cm)}$\n• 예) 반지름 $5\\text{cm}$인 원의 넓이: $\\pi \\times 5^2 = 25\\pi\\text{(cm}^2\\text{)}$',
      type: 'formula',
    },
    {
      id: 'g1d36-c2',
      title: '부채꼴의 호의 길이',
      content: '• 중심각이 $x°$이고 반지름이 $r$인 부채꼴의 **호의 길이**:\n$$l = 2\\pi r \\times \\dfrac{x}{360}$$\n• 예) $r = 6\\text{cm}$, $x = 120°$일 때:\n$l = 2\\pi \\times 6 \\times \\dfrac{120}{360} = 12\\pi \\times \\dfrac{1}{3} = 4\\pi\\text{(cm)}$',
      type: 'formula',
    },
    {
      id: 'g1d36-c3',
      title: '부채꼴의 넓이',
      content: '• 중심각이 $x°$이고 반지름이 $r$인 부채꼴의 **넓이**:\n$$S = \\pi r^2 \\times \\dfrac{x}{360}$$\n• 또는 호의 길이 $l$을 알 때: $S = \\dfrac{1}{2} l r$\n• 예) $r = 6\\text{cm}$, $x = 120°$일 때:\n$S = \\pi \\times 36 \\times \\dfrac{120}{360} = 36\\pi \\times \\dfrac{1}{3} = 12\\pi\\text{(cm}^2\\text{)}$',
      type: 'formula',
    },
  ],
  problems: [
  ...
  realLifeExample: '스프링클러가 회전하며 물을 뿌리는 영역이 부채꼴입니다. 회전 각도와 뿌리는 거리(반지름)를 알면 물이 닿는 면적을 계산할 수 있어요. 와이퍼가 닦는 유리 면적도 부채꼴 넓이 공식으로 구할 수 있습니다!',
};
