...
const dayContent: DayContent = {
  ...
  part: 7,
  title: '기둥의 겉넓이와 부피',
  subtitle: '각기둥과 원기둥의 겉넓이와 부피를 구해 보자!',
  lectures: [],
  concepts: [
    {
      id: 'g1d40-c1',
      title: '각기둥의 겉넓이와 부피',
      content: '**각기둥의 겉넓이**\n$\\text{(겉넓이)} = 2 \\times \\text{(밑넓이)} + \\text{(옆넓이)}$\n\n• 옆넓이 = 밑면의 둘레 $\\times$ 높이\n\n**각기둥의 부피**\n$V = \\text{(밑넓이)} \\times \\text{(높이)}$\n$V = S \\times h$\n\n예) 밑면이 한 변 $4\\text{cm}$인 정사각형, 높이 $10\\text{cm}$인 사각기둥\n$V = 4^2 \\times 10 = 160\\text{cm}^3$',
      type: 'formula',
    },
    {
      id: 'g1d40-c2',
      title: '원기둥의 겉넓이와 부피',
      content: '밑면의 반지름이 $r$, 높이가 $h$인 **원기둥**\n\n**겉넓이**\n$\\text{(겉넓이)} = 2\\pi r^2 + 2\\pi rh$\n$= 2\\pi r(r + h)$\n\n• 밑넓이 = $\\pi r^2$ (2개)\n• 옆넓이 = $2\\pi r \\times h$ (밑면의 둘레 $\\times$ 높이)\n\n**부피**\n$V = \\pi r^2 h$',
      type: 'formula',
    },
  ],
  problems: [
  ...
  realLifeExample: '기둥의 부피 계산은 실생활에서 매우 유용합니다. 물탱크에 담을 수 있는 물의 양, 통조림 캔의 용량, 건물의 기둥 설계 등에 모두 기둥의 부피 공식이 사용됩니다!',
};
