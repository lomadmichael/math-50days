...
const dayContent: DayContent = {
  ...
  realLifeExample: '축하합니다! 50일간의 중1 수학 여정을 완주했습니다! 매일 조금씩 꾸준히 공부한 여러분은 이미 훌륭한 수학적 사고력을 갖추었습니다. 중1 수학은 중학교와 고등학교 수학의 뿌리입니다. 오늘까지 쌓은 기초 위에 중2 수학이라는 새로운 층을 올려보세요. 수학은 쌓아갈수록 더 재미있어집니다!',
};
